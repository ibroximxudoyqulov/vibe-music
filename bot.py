...
# SIZNING YANGI TOZA TOKENINGIZ VA KANALINGIZ:
BOT_TOKEN = "8824021433:AAHsBf1axRyavod-ZZ18uOEmBWxsWYASGV8"
ADMIN_ID = 6526744258
CHANNEL_USERNAME = "@ms_music_karaoke"
WEBAPP_URL = "https://ibroximxudoyqulov.github.io/vibe-music/?v=pro_clean_v120"
...
class HealthCheckHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"<h1>VibeStudio is 100% Active & Live!</h1>")
...
# ==================== 3. LUG'AT VA SODDA MENYU ====================
TEXTS = {
    "uz": {
        "welcome": "Assalomu alaykum! <b>VibeStudio</b>ga xush kelibsiz. 🎧✨\n\n🎬 Spotify uslubidagi estetik videolarni yasash va musiqani qirqish <b>100% BEPUL!</b>\n\n👇 Ilovani ochish uchun pastdagi tugmani bosing:",
